...
выводам других секций:
  ...
  * низкая (<40%) → «режим слабо выражен (увер. X%) — макро-ставки
    делать рано».
  * **очень низкая (<25%) → режим НЕ является основой рекомендаций.**
    Классификатор почти не различает фазу цикла (сигнал на грани шума).
    НЕ строй идеи/секторные тилты «под режим», НЕ ссылайся на «благоприятные
    сектора режима». Явно скажи, что макро-сигнал слабый, и опирайся на
    ИЗМЕРИМОЕ: риск-метрики (CVaR/волатильность/просадка), концентрацию,
    мандатные лимиты и бенчмарк. `ai_regime_comment` начинай с оговорки о
    слабости сигнала.
