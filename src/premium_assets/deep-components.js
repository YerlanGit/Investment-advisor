...
const GaugeCard = ({
  ...
  value: v.riskIndex,
  size: 210
})), v.expReturn && v.expReturn !== '–' && /*#__PURE__*/React.createElement("div", {
  className: "flex items-center justify-center gap-4 mb-2 text-center"
}, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
  className: "text-[10px] text-ink-500 font-medium uppercase tracking-wider"
}, "Ожид. доходность (год.)"), /*#__PURE__*/React.createElement("div", {
  className: "num text-2xl font-light text-sage-600 leading-none mt-1"
  ...
  className: "num text-2xl font-light text-ink-900 leading-none mt-1"
}, v.expSharpe))), /*#__PURE__*/React.createElement("div", {
