  ...
  return (
    <section id="factors" className="rise" data-screen-label="03 Factors">
      <div className="mb-6">
        ...
        {/* Счётчик факторов ПЕЧАТАЕТСЯ ПО ДАННЫМ: осей у модели ровно столько,
            сколько их в таблице, и число «10» здесь жило константой. Тот же
            класс, что счётчики позиций и сценариев (`§−90` A-8, `§−91` B-4). */}
        <p className="text-[15px] text-ink-500 mt-2 font-light max-w-[680px]">
          Скрытые концентрации по {(p.factors || []).length} факторам и оценка
          каждой бумаги по четырём столпам.
        </p>
      </div>
