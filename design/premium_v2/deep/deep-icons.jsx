...
const Icons = {
  ...
  Scale:     (p) => <Icon {...p}><path d="M12 3v18M7 7h10M5 7l-3 6h6zM19 7l-3 6h6zM7 21h10"/></Icon>,
  Activity:  (p) => <Icon {...p}><path d="M22 12h-4l-3 9-6-18-3 9H2"/></Icon>,
  Compass:   (p) => <Icon {...p}><circle cx="12" cy="12" r="9"/><polygon points="16 8 10 10 8 16 14 14" fill="currentColor" fillOpacity="0.15"/></Icon>,
  Dollar:    (p) => <Icon {...p}><path d="M12 2v20M17 6.5C17 4.6 14.8 3.5 12 3.5S7 4.6 7 6.5 9.2 9.5 12 9.5s5 1.1 5 3-2.2 3-5 3-5-1.1-5-3"/></Icon>,
  ...
  Gem:       (p) => <Icon {...p}><path d="M6 3h12l3 6-9 12L3 9z"/><path d="M3 9h18M9 3 6 9l6 12 6-12-3-6"/></Icon>,
  Coin:      (p) => <Icon {...p}><ellipse cx="12" cy="6" rx="8" ry="3"/><path d="M4 6v6c0 1.7 3.6 3 8 3s8-1.3 8-3V6M4 12v6c0 1.7 3.6 3 8 3s8-1.3 8-3v-6"/></Icon>,
};
