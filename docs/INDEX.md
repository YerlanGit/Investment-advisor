...
| 2026-09-23 | `rounds/ROUNDS_91-76.md` разрезан: §−92…§−121 → `ROUNDS_121-92.md` | Файл держал §−76…§−120 (3 524 строки) при имени «91-76»; правило поиска «открывай файл по диапазону» врало. Теперь имя = диапазон под гейтом. |
