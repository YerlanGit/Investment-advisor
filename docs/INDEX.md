...
| [`ECONOMICS.md`](ECONOMICS.md) | 🟢 | Экономика проекта: себестоимость генерации по тирам, все затраты, точка безубыточности, смета масштабирования (MCP, новости, БД), рыночные аналоги. |
