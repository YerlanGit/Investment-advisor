...
| [`ARCHITECTURE_FOR_AGENTS.md`](ARCHITECTURE_FOR_AGENTS.md) | 🟢 | **Читаемость проекта для Claude Code.** Замеры (функции-континенты, контракт `results{}` на 31 ключ и 17 потребителей, корневой `CLAUDE.md` = 5 250 токенов/сессия, 89% тестов названы по фазам) + приоритезированный список улучшений. |
