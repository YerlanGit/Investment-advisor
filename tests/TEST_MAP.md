...
**Замер:** 70 тест-файлов · 52 модулей `src/` имеют хотя бы один адресный тест-импорт.
...
| `finance` | 9 | `test_phase23_scenario.py` · `test_phase35_data_checks.py` · `test_phase39_report_consistency.py` · `test_phase42_instrument_ssot.py` · `test_phase45_data_checks_wiring.py` · `test_phase46_p2_maintainability.py` · `test_phase47_cove_and_fx_honesty.py` · `test_stooq_price_store.py` · `test_stooq_provider.py` |
...
| `finance.data_checks` | 3 | `test_phase35_data_checks.py` · `test_stooq_price_store.py` · `test_stooq_provider.py` |
...
| `finance.stooq_provider` | 2 | `test_phase35_price_providers.py` · `test_stooq_provider.py` |
